...
a persistence unit "examen_AlvaradoDavidPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "examen_AlvaradoDavid/pom.xml":
...
artifact ("examen_AlvaradoDavid.war") is already built. You can build
